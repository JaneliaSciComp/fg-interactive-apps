...
|-----|-----------|-------------|
| **VS Code Server** | [`vscode/`](vscode/) | Browser-based VS Code IDE ([openvscode-server](https://github.com/gitpod-io/openvscode-server)) running in an Apptainer container, with one-click tokenized access. |
